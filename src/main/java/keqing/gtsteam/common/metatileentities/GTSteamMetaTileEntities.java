...
import keqing.gtsteam.common.metatileentities.multi.MetaTileEntityLargePrimitiveBlastFurnace;
...
public class GTSteamMetaTileEntities {
    ...
    public static void initialization() {
        ...
        LARGE_PRIMITIVE_BLAST_FURNACE = registerMetaTileEntity(getID(), new MetaTileEntityLargePrimitiveBlastFurnace(gtsId("large_primitive_blast_furnace")));
